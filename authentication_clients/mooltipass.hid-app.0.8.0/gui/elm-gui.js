...
Elm.Actions.make = function (_elm) {
   ...
   $GuiState = Elm.GuiState.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var commonActions = $Signal.channel($CommonState.CommonNoOp);
   var guiActions = $Signal.channel($GuiState.NoOp);
...
Elm.Content.make = function (_elm) {
   "use strict";
   _elm.Content = _elm.Content || {};
   if (_elm.Content.values)
   return _elm.Content.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $CommonState = Elm.CommonState.make(_elm),
   $CustomGraphics = Elm.CustomGraphics.make(_elm),
   ...
   var asWhiteText = function (x) {
      return $Text.leftAligned(A2($Text.color,
      $Color.white,
      $Text.fromString($Basics.toString(x))));
   };
   var clearButton = function () {
      var aspect = 2.96658357613427;
      var img = function (t) {
         return A3($Graphics$Element.image,
         $Basics.round($Basics.toFloat($Layout.heights.consoleButton) * aspect),
         $Layout.heights.consoleButton,
         A2($Basics._op["++"],
         "images/button_clear-",
         A2($Basics._op["++"],
         t,
      ...
      $CommonState.SetLog(_L.fromArray([]))),
      up,
      hover,
      down);
   }();
   var screen = F2(function (_v0,
   log) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var style = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                  ,_0: "color"
                                                                  ,_1: "white"}
                                                                 ,{ctor: "_Tuple2"
                                                                  ,_0: "font-family"
                                                                 ...
                                                                 ,{ctor: "_Tuple2"
                                                                  ,_0: "width"
                                                                  ,_1: A2($Basics._op["++"],
                                                                  $Basics.toString(_v0._0 - 32),
                                                                  "px")}
                                                                 ,{ctor: "_Tuple2"
                                                                  ,_0: "height"
                                                                  ,_1: A2($Basics._op["++"],
                                                                  $Basics.toString(_v0._1 - 32),
                                                                  "px")}]));
                 var txt = A2($Html.toElement,
                 _v0._0 - 32,
                 _v0._1 - 32)(A2($Html.div,
                 _L.fromArray([style]),
                 A2($List.intersperse,
                 A2($Html.br,
                 _L.fromArray([]),
                 ...
                 $Html.text,
                 $List.reverse(log)))));
                 var txt$ = A4($Graphics$Element.container,
                 _v0._0,
                 _v0._1,
                 ...
                 w$ = $._0,
                 h$ = $._1;
                 var background = A3($Graphics$Collage.collage,
                 _v0._0,
                 _v0._1,
                 _L.fromArray([$Graphics$Collage.filled($CustomGraphics.grey)(A2($CustomGraphics.roundedRect,
                 w$,
                 h$)(A2($Basics.max,
                 w$,
                 h$) / 80))]));
   ...
   var console = F2(function (_v4,
   log) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return function () {
                 var screenW = _v4._0 - 64;
                 var screenH = _v4._1 - $Layout.heights.consoleToolbar - 32;
                 var screen$ = A3($Graphics$Element.container,
                 _v4._0,
                 screenH,
                 $Graphics$Element.middle)(A2(screen,
                 {ctor: "_Tuple2"
                 ,_0: screenW
                 ,_1: screenH},
                 log));
                 var toolbar = A4($Graphics$Element.container,
                 _v4._0,
                 $Layout.heights.consoleToolbar,
                 $Graphics$Element.middle,
                 clearButton);
   ...
   var content = F2(function (_v8,
   state) {
      return function () {
         switch (_v8.ctor)
         {case "_Tuple2":
            return function () {
                 var h$ = _v8._1 - $Layout.heights.marginTop - $Layout.heights.nav - $Layout.heights.marginBottom;
                 var background = A3($Graphics$Collage.collage,
                 _v8._0,
                 h$,
                 _L.fromArray([$Graphics$Collage.filled($CustomGraphics.darkGrey)(A2($Graphics$Collage.rect,
   ...
   _elm.Content.values = {_op: _op
                         ,content: content
                         ,console: console
                         ,screen: screen
                         ,clearButton: clearButton
                         ,asWhiteText: asWhiteText};
   return _elm.Content.values;
};
Elm.CustomGraphics = Elm.CustomGraphics || {};
Elm.CustomGraphics.make = function (_elm) {
   "use strict";
   _elm.CustomGraphics = _elm.CustomGraphics || {};
   if (_elm.CustomGraphics.values)
   return _elm.CustomGraphics.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   16,
   16);
   var grey = A3($Color.rgb,
   26,
   26,
   26);
   var arc = F3(function (_v0,
   _v1,
   _v2) {
      return function () {
         switch (_v2.ctor)
                 ...
                 {case "_Tuple2":
                    return function () {
                         ...
                         {case "_Tuple2":
                            return function () {
                                 var n = 50;
                                 var t = (_v2._1 - _v2._0) / n;
                                 var f = function (i) {
                                    return {ctor: "_Tuple2"
                                           ,_0: _v0._0 + _v1._0 * $Basics.cos(t * i + _v2._0)
                                           ,_1: _v0._1 + _v1._1 * $Basics.sin(t * i + _v2._0)};
                                 };
                                 return A2($List.map,
                                 f,
                                 _L.range(0,n - 1));
   ...
   r) {
      return function () {
         ...
         {ctor: "_Tuple2"
         ,_0: $Basics.degrees(270)
         ,_1: $Basics.degrees(180)}),
         A2($Basics._op["++"],
         A3(arc,
         {ctor: "_Tuple2"
         ,_0: 0 - hw + r
   ...
   _elm.CustomGraphics.values = {_op: _op
                                ,arc: arc
...
Elm.GUI.make = function (_elm) {
   ...
   var toBackground = _P.portOut("toBackground",
   _P.outgoingSignal(function (v) {
      return {setLog: v.setLog.ctor === "Nothing" ? null : Elm.Native.List.make(_elm).toArray(v.setLog._0).map(function (v) {
                return v;
             })
             ,getState: v.getState.ctor === "Nothing" ? null : []};
   }),
   A2($Signal._op["<~"],
   $FromGuiMessage.encode,
   $Signal.subscribe($Actions.commonActions)));
   var fromBackground = _P.portIn("fromBackground",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && "setLog" in v && "setConnected" in v ? {_: {}
                                                                             ,setLog: typeof v.setLog === "object" && v.setLog instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.setLog.map(function (v) {
                                                                                return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
                                                                                v);
                                                                             })) : _U.badPort("an array",
                                                                             v.setLog)
                                                                             ,setConnected: typeof v.setConnected === "number" ? v.setConnected : _U.badPort("a number",
                                                                             v.setConnected)} : _U.badPort("an object with fields \'setLog\', \'setConnected\'",
      v);
   }));
   var state = A2($Signal.foldp,
   $GuiState.apply,
   $GuiState.$default)($Signal.merge(A2($Signal._op["<~"],
   function (m) {
      return _L.fromArray([m]);
   },
   $Signal.subscribe($Actions.guiActions)))(A2($Signal._op["<~"],
   $List.map($GuiState.CommonAction),
   A2($Signal._op["<~"],
   $ToGuiMessage.decode,
   fromBackground))));
...
Elm.GuiState = Elm.GuiState || {};
Elm.GuiState.make = function (_elm) {
   "use strict";
   _elm.GuiState = _elm.GuiState || {};
   if (_elm.GuiState.values)
   return _elm.GuiState.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $CommonState = Elm.CommonState.make(_elm),
   $List = Elm.List.make(_elm);
   var fromCommonState = F2(function (com,
   gui) {
   ...
   var ClickIcon = {ctor: "ClickIcon"};
   var ChangeTab = function (a) {
      return {ctor: "ChangeTab"
             ,_0: a};
   };
   var GuiState = F4(function (a,
   b,
   c,
   d) {
      return {_: {}
   ...
   var Manage = {ctor: "Manage"};
   var Settings = {ctor: "Settings"};
   var disabledTabs = function (s) {
      return function () {
         switch (s.ctor)
         {case "Connected":
            return _L.fromArray([]);
            case "NoCard":
            return _L.fromArray([Settings
                                ,Manage]);
            case "NoPin":
            return _L.fromArray([Settings
                                ,Manage]);
   ...
   s) {
      return function () {
         ...
         return function () {
            switch (action.ctor)
            {case "ChangeTab":
               return _U.replace([["activeTab"
                                  ,action._0]],
                 s);
               case "ClickIcon":
               return _U.cmp(s.iconClicked,
                 6) > -1 ? _U.replace([["iconClicked"
                                       ,0]
                                      ,["devEnabled"
                                       ,$Basics.not(s.devEnabled)]
                                      ,["activeTab"
                                       ,_U.eq(s.activeTab,
                                       Developer) && s.devEnabled ? Log : s.activeTab]],
                 s) : _U.replace([["iconClicked"
                                  ,s.iconClicked + 1]],
                 s);
               case "CommonAction":
               return function () {
                    ...
                    {case "SetConnected":
                       return _U.replace([["activeTab"
                                          ,A2($List.member,
                                          s.activeTab,
                                          disabledTabs(action._0._0)) ? Log : s.activeTab]
                                         ,["common"
   ...
   _elm.GuiState.values = {_op: _op
                          ...
                          ,NoOp: NoOp
                          ,fromCommonState: fromCommonState
                          ,$default: $default
...
Elm.Navigation.make = function (_elm) {
   ...
   disabled) {
      return function () {
         ...
         var aspect = 3.094594610699232;
         var img = function (t) {
            return A3($Graphics$Element.image,
            $Basics.round($Basics.toFloat($Layout.heights.tab) * aspect),
            $Layout.heights.tab,
            A2($Basics._op["++"],
            "images/tab_",
            A2($Basics._op["++"],
         ...
         var up = img("inactive");
         var hover = img("hover");
         var down = img("inactive");
         var button = A4($Graphics$Input.customButton,
         A2($Signal.send,
         $Actions.guiActions,
         $GuiState.ChangeTab(t)),
         up,
         hover,
         down);
         var disabledButton = img("disabled");
         var activeButton = img("active");
         return A2($List.member,
         t,
         disabled) ? disabledButton : _U.eq(t,
         active) ? activeButton : button;
      }();
   });
   var navLine = function (w) {
      return A3($Graphics$Element.tiledImage,
      w,
      1,
      "images/tab_spacer_pixel.png");
   };
   var navSpacer = function (w) {
   ...
   var tabs = function (state) {
      return function () {
         var disabled = $GuiState.disabledTabs(state.common.connected);
         return $Graphics$Element.flow($Graphics$Element.right)(A2($Basics._op["++"],
         _L.fromArray([A3(tab,
         $GuiState.Log,
         state.activeTab,
         disabled)]),
         _L.fromArray([navSpacer(9000)])));
      }();
   };
   var statusIcon = function (c) {
      return function () {
         var aspect = 1.3285316308250572;
         var width = $Basics.round($Basics.toFloat($Layout.heights.icon) * aspect);
         var img = function (color) {
            return A3($Graphics$Element.image,
            width,
            $Layout.heights.icon,
            A2($Basics._op["++"],
         ...
         var icon = function () {
            switch (c.ctor)
            {case "Connected":
               return clickIcon("blue");
               case "NoCard":
               return clickIcon("orange");
               case "NoPin":
               return clickIcon("purple");
               case "NotConnected":
               return clickIcon("red");}
            _U.badCase($moduleName,
            "between lines 34 and 39");
         }();
         ...
         _L.fromArray([icon
                      ...
                      1,
                      $Layout.heights.iconPadding)
                      ,navLine(width)]));
      }();
   };
   var navigation = F2(function (_v2,
   state) {
      return function () {
         switch (_v2.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.flow,
              ...
              _L.fromArray([A4($Graphics$Element.container,
                           $Basics.round($Basics.toFloat(_v2._0) * 0.85),
                           $Layout.heights.nav,
                           $Graphics$Element.midLeft,
                           A2($Graphics$Element.flow,
                           $Graphics$Element.right,
                           _L.fromArray([navSpacer(38)
                                        ,tabs(state)])))
                           ,A4($Graphics$Element.container,
                           $Basics.round($Basics.toFloat(_v2._0) * 0.15),
                           $Layout.heights.nav,
                           $Graphics$Element.midRight,
                           A2($Graphics$Element.flow,
                           $Graphics$Element.left,
                           _L.fromArray([navSpacer(32)
                                        ,statusIcon(state.common.connected)
                                        ,navSpacer(9000)])))]));}
         _U.badCase($moduleName,
...
Elm.Scene.make = function (_elm) {
   ...
   if (_elm.Scene.values)
   return _elm.Scene.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "Scene",
   $Content = Elm.Content.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $GuiState = Elm.GuiState.make(_elm),
   $Layout = Elm.Layout.make(_elm),
   $Navigation = Elm.Navigation.make(_elm);
   var layer1 = F2(function (dims,
   state) {
      return A2($Graphics$Element.flow,
      $Graphics$Element.down,
      _L.fromArray([A2($Graphics$Element.spacer,
                   1,
                   $Layout.heights.marginTop)
                   ,A2($Navigation.navigation,
                   dims,
                   state)
                   ,A2($Content.content,
                   dims,
   ...
   var scene = F2(function (dims,
   state) {
      return $Graphics$Element.layers(_L.fromArray([A2(layer1,
      dims,
      state)]));
   });
   _elm.Scene.values = {_op: _op
                       ,scene: scene
                       ,layer1: layer1};
   return _elm.Scene.values;
};
