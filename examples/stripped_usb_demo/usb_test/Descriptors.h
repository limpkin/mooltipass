...
#define _DESCRIPTORS_H_
	...
	/* Macros: */
        ...
        // HID Data report size, set to the max endpoint size
		#define HID_DATA_REPORT_SIZE        64
        // Control endpoint size, defined by the atmega32u4
        #define CONTROL_ENDPOINT_SIZE       64
        // Keyboard endpoint size
        #define KEYBOARD_ENDPOINT_SIZE      8
        // Generic HID interface endpoint size
        #define GENERIC_HID_ENDPOINT_SIZE   64
        ...
        // Enum for the interface numbers
        enum IntefaceDescriptors_t
        {
            INTERFACE_ID_GENERIC = 0,
