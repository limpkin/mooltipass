 ...
 * CDDL HEADER END
 */
/*!  \file     standard_gui_screen_functions.h
...
#ifndef STANDARD_GUI_SCREEN_FUNCTIONS_H_
#define STANDARD_GUI_SCREEN_FUNCTIONS_H_
...
#endif /* STANDARD_GUI_SCREEN_FUNCTIONS_H_ */