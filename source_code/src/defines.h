 ...
 *
 *  MINI_KICKSTARTER_SETUP_UPDATE
 *  => mooltipass mini production kickstarter version update (8Mb)
*/
#define MINI_KICKSTARTER_SETUP_UPDATE
...
//    #define DATA_STORAGE_EN
    ...
    #define DISABLE_USB_SET_UID_DEV_PASSWORD_COMMANDS
    #define KNOCK_SETTINGS_CHANGE_PREVENT_WHEN_CARD_INSERTED
#elif defined(MINI_KICKSTARTER_SETUP_UPDATE)
    #define MINI_VERSION
    #define FLASH_CHIP_8M
    #define DATA_STORAGE_EN
    #define HARDWARE_MINI_CLICK_V2
...
/**************** VERSION DEFINES ***************/
    ...
    #define MOOLTIPASS_VERSION "v1.3"
#endif
