#!/bin/bash
sudo apt-get update
sudo apt-get -y --force-yes install python python-pip avrdude python-crypto python-dev libgmp3-dev build-essential python-numpy python-matplotlib python-wheel libjpeg-dev < /dev/null
