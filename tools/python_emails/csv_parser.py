...
if __name__ == '__main__':
	...
	for order_item in orders_list:		
		...
		if perk_email_sending and first_email_found:
			...
			body_of_email += "<a href=\"https://docs.google.com/forms/d/19c60hwk_gOm1ce2Ctpgy0RRfx7ODkNK9ykDpkfxai5o/viewform?entry.1043764275="+order_item[INDEX_NAME]+"&entry.1932639819="+order_item[INDEX_EMAIL_ADDR]+"&entry.1617982862=" + hashlib.sha512(SECRET_SALT+order_item[INDEX_EMAIL_ADDR]).hexdigest() + "\">here</a>.<br>"
