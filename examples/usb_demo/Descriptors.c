                                    ...
                                    const void** const DescriptorAddress)
{
	...
	switch (DescriptorType)
	{
		...
		case HID_DTYPE_HID:
		    switch( wIndex )
		    {
		        case 0: Address = &ConfigurationDescriptor.HID_GenericHID;
					     Size    = sizeof(USB_HID_Descriptor_HID_t);
		                 break;
		        case 1: Address = &ConfigurationDescriptor.HID1_KeyboardHID;
						 Size    = sizeof(USB_HID_Descriptor_HID_t);
		                 break;
		    }
		break;
